...
<body>
    <form action="/buyer/payment" method="post" id="paymentForm">
                        ...
                        <div class="top_wrap">
                            <div class="area1">
                                ...
                                <div class="area1_2">
                                    ...
                                    <input type="hidden" name="menuCode${status.index }" id="menuCode" value="${cart.menuCode }">
                                    <input type="hidden" name="menuName${status.index }" id="menuName" value="${cart.menuName }">
                                    <input type="hidden" name="price${status.index }" id="price" value="${cart.price }">
                            ...
                            <div class="area3">
                                ...
                                <div class="area3_3">
                                    <textarea id="textBox" name="bRequest" cols="35" rows="3.5" style="border: 3.5px solid black; border-radius: 5px; font-size: 16px; font-family: scDreamL;" maxlength="100"></textarea>
