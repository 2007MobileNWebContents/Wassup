...
<body>
    <form action="/seller/info" method="post">
        ...
        <div id="content">
                ...
                <div id="information">
                    <div id="buyer_info">
                        <div class="b_info">
                            ...
                            <div class="b_info_2">판매자</div>
                        </div>
                        <div class="line"></div>
                        <div class="b_info">
                            <div class="b_info_1">주문 관리</div>
                            <div class="b_info_2">${totalOrder }개</div>
                            <div class="b_info_3">
                                <a href="/seller/list/order" class="btn_style" style="color: black">상세</a>
                            </div>
                        </div>
                        <div class="line"></div>
                        <div class="b_info">
                            <div class="b_info_1">리뷰 관리</div>
                            <div class="b_info_2">${totalReview }개</div>
                            <div class="b_info_3">
                                <a href="/seller/reviewList" class="btn_style" style="color: black">상세</a>
                            </div>
                        </div>
                        <div class="line"></div>
                        <div class="b_info">
                            ...
                            <div class="b_info_4">
                                <a href="/seller/info" class="btn_style" style="color: black">수정</a>
                            </div>
                            <div class="b_info_5">
            ...
            <div id="btn_content">
                <div id="btn_div">
                    ...
                    <div class="btn2"><a href="/lastorder/list2">라스트오더 관리</a></div>
                    <div class="btn3"><a href="/menu/list">메뉴관리</a></div>
                </div>
            </div>
        </div>
    </div>
