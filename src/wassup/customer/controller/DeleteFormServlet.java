...
/**
 * Servlet implementation class DeletebtnServlet
 */
@WebServlet("/customer/deleteForm")
public class DeleteFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/customer/customerDelete.jsp").forward(request, response);
	}
