...
/**
 * Servlet implementation class BuyerOrderOne
 */
@WebServlet("/buyer/order/one")
public class BuyerOrderOne extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuyerOrderOne() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!oList.isEmpty()) {
			...
			request.getRequestDispatcher("/WEB-INF/views/customer/buyerOrderOne.jsp").forward(request, response);
